...
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
	...
	?>
		<tr>
			<td style="padding-top: 0px;padding-bottom: 0px; font-family: arial, verdana, helvetica; font-size: 11px;width:80px;">Загрузка:</td>
		...
		<tr>
			...
			<td style="padding-top: 0px;padding-bottom: 2px;font-family: tahoma; font-size: 9px;">(Max размер: <?php echo $phpmaxsize; ?>KB)</td>
		</tr>
	<?php
		}
		else {
...
Загрузка файлов отключена в вашем файле php.ini. Пожалуйста, включите их.
			</td>
		</tr>
	<?php
		}
	...
	?>
	<tr>
		<td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;" width="80">Ссылка на изображение:</td>
...
<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Настройки:</span>
...
<tr>
  <td style="width: 115px;padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;" width="100">Выравнивание:</td>
	...
	<select name="align" id="align" style="font-family: arial, verdana, helvetica; font-size: 11px; width: 100%;">
	 ...
	 <option value="absmiddle">По середине</option>
	 <option value="baseline">Базисный</option>
	 <option value="absbottom">По центру снизу</option>
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Горизонтальный отступ:</td>
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Вертикальный отступ:</td>
...
<td style="vertical-align: top;width: 150px; padding-left: 5px;">
	<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Выберите изображение:</span>
...
<tr>
	<td colspan="2" align="right" style="padding-top: 5px;">
		...
		<?php } ?> 		
		<input type="button" value="Отмена" onclick="window.close();" style="font-size: 12px;">	
	</td>
</tr>
</form>
</table>
